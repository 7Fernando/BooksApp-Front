 ...
 // import emailjs from 'emailjs-com'
  ...
  const Contact = () => {
    ...
    function envioMail(e){
        e.preventDefault(e);
        emailjs.sendForm('service_x7dun2b', 'template_be63qb1', form.current, "SHKb26CwJjN227AuP").then(res=> {alert("Mje enviado correctamente"),
        console.log(res)})
    }
    ...
    return (
      ...
      <div className={styles.container}>
          <h1 className={styles.logo}> Contact <span>Us</span></h1>
         
              <div className={styles.contactform}>
        <form ref={form} onSubmit={envioMail}>
            <p>
            <label>Name</label>
...
//     const { hasCopied, onCopy } = useClipboard('bookflixemail@gmail.com');
